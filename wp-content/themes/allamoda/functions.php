...
//  wp_enqueue_script('modernizr', get_template_directory_uri() . '/js/vendor/modernizr.js', array(), '1.0', true);
  ...
  wp_enqueue_script('commoncustom', get_template_directory_uri() . '/js/common.js', array(), '1.1', true);
}
...
function allamoda_subcats_from_parentcat_by_ID($parent_cat_ID)
{
  $args = array(
    'hierarchical' => 1,
    'show_option_none' => '',
...
function allamoda_subcats_from_parentcat_by_NAME($parent_cat_NAME)
{
  $IDbyNAME = get_term_by('slug', $parent_cat_NAME, 'category');
