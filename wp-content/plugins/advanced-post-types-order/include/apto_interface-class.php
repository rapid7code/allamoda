        ...
        function reorder_interface()
            {
                ...
                $this->admin_functions->nottice_similar_sorts($this);
                                ...
                                <tbody>
                                    <tr id="query_rules">
                                        <td class="label">
                                            ...
                                            <p class="description"><?php _e( "All rules are compared to a query using AND operator. For more details check", 'apto' ) ?> <a href="http://www.nsp-code.com/advanced-post-types-order-description-and-usage/understanding-sort-list-settings-area/"><?php _e( "Query Rules examples", 'apto' ) ?></a></p>
                                        </td>
                                        <td>
                                    ...
                                    <tr id="conditional_rules">
                                        <td class="label">
                                            ...
                                            <p class="description"><?php _e( "Apply the order only if conditions are true.", 'apto' ) ?></p>
                                        </td>
                                        <td>
                                    ...
                                    <tr>
                                        <td class="label">
                                            ...
                                            <p class="description"><?php _e( "This sort interface settings", 'apto' ) ?></p>
                                        </td>
                                        <td class="np">
