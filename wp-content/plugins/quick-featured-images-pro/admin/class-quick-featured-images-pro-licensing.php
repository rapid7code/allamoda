...
class Quick_Featured_Images_Pro_Licensing { // only for debugging: extends Quick_Featured_Images_Pro_Base {
	...
	public function main() {
		...
		switch ( $license_status ) {
			case 'valid':
				$msg = __( 'The license is valid and active.', $this->plugin_slug );
				break;
			case 'expired':
				$msg = __( 'The license is expired.', $this->plugin_slug );
				break;
			case 'invalid':
				$msg = __( 'The license key does not match.', $this->plugin_slug );
				break;
			case 'inactive':
				$msg = __( 'The license is not activated.', $this->plugin_slug );
				break;
			case 'disabled':
				$msg = __( 'The license is disabled.', $this->plugin_slug );
				break;
			case 'site_inactive':
				$msg = __( 'The license is inactive.', $this->plugin_slug );
				break;
			default:
				$msg = __( 'The status of the license is unknown.', $this->plugin_slug );
		} // switch ( $license_status )
	...
	public function get_page_headline() {
		return __( 'License Activation', $this->plugin_slug );
	}
	...
	public function get_page_description() {
		return __( 'Enter the license key to get automatic upgrades of the plugin.', $this->plugin_slug );
	}
