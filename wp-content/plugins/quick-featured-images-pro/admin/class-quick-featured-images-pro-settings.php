 ...
 * @author    Martin Stehle <m.stehle@gmx.de>
 */
class Quick_Featured_Images_Pro_Settings {
	 ...
	 * @var      array
	 */
	protected $main_options_page_slug = 'quick-featured-images-pro-optionspage';
	 ...
	 * @var      array
	 */
	protected $settings_fields_slug = 'quick-featured-images-pro-options';
	...
	private static function set_default_settings() {
		...
		$db_slug = 'quick-featured-images-pro-settings'; // todo: get the value from $settings_db_slug both in object and non-object context
