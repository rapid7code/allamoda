...
?>
<p>
	<label for="<?php printf( 'qfi_%s', $custom_tax ); ?>"><?php printf( __( 'Registered terms of the taxonomy <strong>%s</strong>', $this->plugin_slug ), $custom_tax_labels[ $custom_tax ] ); ?></label><br />
