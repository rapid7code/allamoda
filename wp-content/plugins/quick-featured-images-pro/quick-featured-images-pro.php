...
if ( is_admin() ) {
	...
	require_once( $root . 'admin/class-quick-featured-images-pro-admin.php' );
	 ...
	 *
	 */
	require_once( $root . 'admin/class-quick-featured-images-pro-tools.php' );
	 ...
	 *
	 */
	require_once( $root . 'admin/class-quick-featured-images-pro-defaults.php' );
	 ...
	 *
	 */
	require_once( $root . 'admin/class-quick-featured-images-pro-settings.php' );
	 ...
	 *
	 */
	require_once( $root . 'admin/class-quick-featured-images-pro-columns.php' );
	 ...
	 *
	 */
	require_once( $root . 'admin/class-quick-featured-images-pro-licensing.php' );
